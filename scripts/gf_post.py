...
font["name"].setName("Copyright 2025 The Chiron Sung HK Project Authors (https://github.com/chiron-fonts/chiron-sung-hk)",0,3,1,1033)
if "It" in str(file):
	font["name"].setName("ChironSungHK-ExtraLightItalic",6,3,1,1033)
	font["name"].setName("Chiron Sung HK ExtraLight",1,3,1,1033)
	font["name"].setName("Italic",2,3,1,1033)
else:
	font["name"].setName("ChironSungHK-ExtraLight",6,3,1,1033)

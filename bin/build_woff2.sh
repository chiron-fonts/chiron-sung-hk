...
build_vf_woff2 "regular" "$BUILD_VF_DIR/ChironSungHKVF.otf" $BUILD_WOFF2_OTF_DIR "vf"
build_vf_woff2 "regular" "$BUILD_VF_DIR/ChironSungHKVF.ttf" $BUILD_WOFF2_TTF_DIR "vf"

build_vf_woff2 "italic" "$BUILD_VF_DIR/ChironSungHKItVF.otf" $BUILD_WOFF2_OTF_DIR "vf-italic"
build_vf_woff2 "italic" "$BUILD_VF_DIR/ChironSungHKItVF.ttf" $BUILD_WOFF2_TTF_DIR "vf-italic"
